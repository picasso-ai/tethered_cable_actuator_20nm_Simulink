#include "Motor_Control_GeminiActuator.h"

Motor_Control_GeminiActuator::Motor_Control_GeminiActuator(uint8_t id, int Can_id)
{
  ID = id;
}
Motor_Control_GeminiActuator::~Motor_Control_GeminiActuator()
{}
void Motor_Control_GeminiActuator::init_motor_CAN()
{
  //initial CAN Bus
...
void Motor_Control_GeminiActuator::DataExplanation(CAN_message_t msgR2)
{
  int len = msgR2.len;
  if (len == 8)
  {
...
void Motor_Control_GeminiActuator::read_PID()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::write_PID_RAM(uint8_t Kp_pos,uint8_t Ki_pos,uint8_t Kp_vel,uint8_t Ki_vel,uint8_t Kp_cur,uint8_t Ki_cur)
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::write_PID_ROM(uint8_t Kp_pos,uint8_t Ki_pos,uint8_t Kp_vel,uint8_t Ki_vel,uint8_t Kp_cur,uint8_t Ki_cur)
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
//******4.Read Acceleration******//
void Motor_Control_GeminiActuator::read_acceleration()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::write_acceleration_RAM()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_encoder()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::write_encoder_offset_RAM(uint16_t encoder_Offset )
{
...
void Motor_Control_GeminiActuator::write_current_position_as_zero_position()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_multi_turns_angle()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_single_turns_angle()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::clear_motor_angle_command()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_motor_status()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::clear_motor_error()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_motor_status_2()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::read_motor_status_3()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::close_motor()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::stop_motor()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
//******18.start motor******//
void Motor_Control_GeminiActuator::start_motor()
{
  msgW.id = 0x140 + ID;
  msgW.ext = 0;
  msgW.len = 8;
...
void Motor_Control_GeminiActuator::send_current_command(double current)
{
...
void Motor_Control_GeminiActuator::send_speed_command(double speedvalue)
{
...
void Motor_Control_GeminiActuator::send_position_command(double angle)
{
  angle = angle * 100;
...
void Motor_Control_GeminiActuator::send_position_command_2(double angle, double max_speed)
{
  angle = angle * 100;
  angleControl = (int32_t)angle;
...
//(limited by maximum angle)//
//(limited by maximum current)//
void Motor_Control_GeminiActuator::send_position_command_3(double angle, uint8_t spinDirection)
{
  angle = angle * 100;
...
//(limited by maximum angle)//
//(limited by maximum current)//
void Motor_Control_GeminiActuator::send_position_command_4(double angle, double max_speed, uint8_t spinDirection)
{
  angle = angle * 100;
  angleControl = (uint8_t)angle;
...
void Motor_Control_GeminiActuator::send_multi_motor_current_command(double Motor1_current, double Motor2_current, double Motor3_current, double Motor4_current)
{
