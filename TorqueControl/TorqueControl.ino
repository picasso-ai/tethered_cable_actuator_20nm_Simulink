...
double gear_ratio = 8;//The actuator gear ratio, will enfluence actuator angle and angular velocity
...
Motor_Control_GeminiActuator m1(Motor_ID, CAN_ID); //Create motor object see Motor_Control_GeminiActuator.h
